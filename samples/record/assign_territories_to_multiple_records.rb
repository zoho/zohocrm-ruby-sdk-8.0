...
class AssignTerritoriesToMultipleRecords
	def self.assign_territories_to_multiple_records
		begin
					...
					if response_handler.is_a? ZOHOCRMSDK::Record::ActionWrapper
						...
						action_response_list.each_with_index do |action_response, index|
							if action_response.is_a? ZOHOCRMSDK::Record::SuccessResponse
								...
								print "Territory Assignment Operation #{index + 1} Status: SUCCESS\n"
								...
								print "Territory Assignment Operation #{index + 1} Status: ERROR\n"
						...
						print "Assign Territories to Multiple Records API Exception:\n"
	...
	def self.initialize_and_call
		begin
			...
			assign_territories_to_multiple_records
		rescue Exception => e
			raise e
		end
	end
