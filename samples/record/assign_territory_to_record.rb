...
class AssignTerritoryToRecord
	def self.assign_territory_to_record
		begin
			...
			territory.id = 1055806000003051357  # Replace with actual territory ID
					...
					if response_handler.is_a? ZOHOCRMSDK::Record::ActionWrapper
						...
						action_response_list.each_with_index do |action_response, index|
							if action_response.is_a? ZOHOCRMSDK::Record::SuccessResponse
								...
								print "Territory Assignment #{index + 1} Status: SUCCESS\n"
								...
								print "Territory Assignment #{index + 1} Status: ERROR\n"
						...
						print "Assign Territory API Exception:\n"
...
AssignTerritoryToRecord.initialize_and_call