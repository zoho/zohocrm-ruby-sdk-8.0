...
class UpdateRelatedRecordUsingExternalId
	def self.update_related_record_using_external_id
		begin
			...
			header_instance.add(ZOHOCRMSDK::RelatedRecords::RelatedRecordsOperations::UpdateRelatedRecordUsingExternalIDHeader.X_external, "Leads.External,Products.Products_External")
			
			response = related_records_operations.update_related_record_using_external_id(external_field_value, external_id, request, header_instance)
	...
	def self.initialize_and_call
		begin
			...
			update_related_record_using_external_id
		rescue Exception => e
			raise e
		end
	end
