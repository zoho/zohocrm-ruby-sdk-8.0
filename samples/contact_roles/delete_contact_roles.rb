...
class DeleteContactRoles
	def self.delete_contact_roles
		contact_roles_operations = ZOHOCRMSDK::ContactRoles::ContactRolesOperations.new
		param_instance = ZOHOCRMSDK::ParameterMap.new
		
		# Add role IDs to delete - can specify multiple IDs
		role_ids = ["1055806000028870002", "1055806000000691006"]  # Replace with actual role IDs
		param_instance.add(ZOHOCRMSDK::ContactRoles::ContactRolesOperations::DeleteContactRolesParam.ids, role_ids.join(","))
...
DeleteContactRoles.initialize_and_call