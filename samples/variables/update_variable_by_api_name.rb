...
class UpdateVariableByApiName
	def self.update_variable_by_api_name(api_name)
		begin
			...
			variable.value = 20
			variable.description = "Updated description using API name endpoint"
			...
			# param_instance.add(ZOHOCRMSDK::Variables::VariablesOperations::UpdateVariableByAPINameParam.group, "General")
			
			response = variables_operations.update_variable_by_apiname(api_name, body_wrapper, param_instance)
	...
	def self.initialize_and_call
		begin
			...
			api_name = "var12345"
			update_variable_by_api_name(api_name)
		rescue Exception => e
			raise e
		end
	end
...
UpdateVariableByApiName.initialize_and_call