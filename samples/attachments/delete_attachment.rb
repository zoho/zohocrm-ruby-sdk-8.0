...
class DeleteAttachment
	def self.delete_attachment
		attachment_id = 1055806000028864002
		...
		response = attachments_operations.delete_attachment(attachment_id, record_id, module_name)
		if response != nil
...
DeleteAttachment.initialize_and_call