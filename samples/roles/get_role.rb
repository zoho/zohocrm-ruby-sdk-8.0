...
class GetRole
	def self.get_role
		begin
			# Set the role ID (replace with actual role ID)
			role_id = 1055806000000026005  # Replace with actual role ID
			...
			if response != nil
				...
				if [204, 304].include?(response.status_code)
					print (response.status_code == 204 ? "No Content - Role not found" : "Not Modified") + "\n"
					return
				end
