...
class GetRelatedLists
	def self.get_related_lists
		begin
			...
			param_instance.add(ZOHOCRMSDK::RelatedLists::RelatedListsOperations::GetRelatedListsParam.module_1, "Leads")
			...
			if response != nil
				...
				if [204, 304].include?(response.status_code)
					print (response.status_code == 204 ? "No Content - No related lists found" : "Not Modified") + "\n"
					return
				end
...
GetRelatedLists.initialize_and_call