...
class UpdateSharingRule
		def self.update_sharing_rule(id, module_api_name)
			...
			response = sharing_rules_operations.update_sharing_rule(id, request)
			if response != nil
	...
	def self.initialize_and_call
			begin
				...
				id = 34770551001
				update_sharing_rule(id, module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
UpdateSharingRule.initialize_and_call