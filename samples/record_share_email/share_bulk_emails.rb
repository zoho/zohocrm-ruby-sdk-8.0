...
class ShareBulkEmails
  ...
  def self.share_bulk_emails(module_api_name)
    ...
    request.ids = [34770623, 34770020]
    response = record_share_email_operations.share_bulk_emails(request)
  ...
  def self.initialize_and_call
    begin
      ...
      share_bulk_emails(module_api_name)
    rescue Exception => e
      raise e
    end
  end
...
ShareBulkEmails.initialize_and_call