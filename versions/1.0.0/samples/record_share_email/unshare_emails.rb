...
class UnshareEmails
  ...
  def self.initialize_and_call
    begin
      ...
      id=32342213232
      unshare_emails(module_api_name, id)
    rescue Exception => e
      raise e
    end
  end
end
UnshareEmails.initialize_and_call