...
class ExecuteFunctionUsingParameters
		def self.execute_function_using_parameters
			...
			response = functions_operations.execute_function_using_parameters(param_instance, header_instance)
			if response != nil
	...
	def self.initialize_and_call
			begin
				...
				execute_function_using_parameters
			rescue Exception => e
				raise e
			end
		end
end
ExecuteFunctionUsingParameters.initialize_and_call