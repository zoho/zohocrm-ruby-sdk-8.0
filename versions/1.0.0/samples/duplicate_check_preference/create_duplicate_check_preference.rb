...
class CreateDuplicateCheckPreference
		def self.create_duplicate_check_preference(module_api_name)
			...
			mapped_module.id="7272250000037"
	...
	def self.initialize_and_call
			begin
				...
				create_duplicate_check_preference(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
CreateDuplicateCheckPreference.initialize_and_call