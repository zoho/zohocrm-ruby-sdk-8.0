  ...
  module Notifications
    class NotificationCondition
      ...
      def field_selection
        ...
        # @param field_selection [Criteria] An instance of Criteria

      def field_selection=(field_selection)
        if field_selection!=nil and !field_selection.is_a? Criteria
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: field_selection EXPECTED TYPE: Criteria', nil, nil)
        end
        @field_selection = field_selection
        @key_modified['field_selection'] = 1
      end
