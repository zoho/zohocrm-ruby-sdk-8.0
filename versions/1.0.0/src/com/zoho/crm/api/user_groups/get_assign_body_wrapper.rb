  ...
  module UserGroups
    class GetAssignBodyWrapper
      ...
      def assigned
        ...
        # @param get_assigned [Assign] An instance of Assign

      def assigned=(get_assigned)
        if get_assigned!=nil and !get_assigned.is_a? Assign
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: get_assigned EXPECTED TYPE: Assign', nil, nil)
        end
