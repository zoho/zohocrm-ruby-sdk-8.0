  ...
  module Webforms
    class SpamControll
      ...
      def exclude_score
        ...
        # @param exclude_score [String] A String

      def exclude_score=(exclude_score)
        if exclude_score!=nil and !exclude_score.is_a? String
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: exclude_score EXPECTED TYPE: String', nil, nil)
        end
        @exclude_score = exclude_score
        @key_modified['exclude_score'] = 1
      end
