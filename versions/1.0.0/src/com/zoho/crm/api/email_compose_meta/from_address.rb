  ...
  module EmailComposeMeta
    class FromAddress
      ...
      def default
        ...
        # @param default [Util::Choice] An instance of Util::Choice

      def default=(default)
        if default!=nil and !default.is_a? Util::Choice
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: default EXPECTED TYPE: Util::Choice', nil, nil)
        end
        @default = default
