  ...
  module HipaaCompliance
    class ActionWrapper
      ...
      def hipaa_compliance
        ...
        # @param hipaa_compliance [ActionResponse] An instance of ActionResponse

      def hipaa_compliance=(hipaa_compliance)
        if hipaa_compliance!=nil and !hipaa_compliance.is_a? ActionResponse
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: hipaa_compliance EXPECTED TYPE: ActionResponse', nil, nil)
        end
