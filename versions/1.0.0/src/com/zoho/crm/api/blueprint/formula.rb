  ...
  module Blueprint
    class Formula
      ...
      def expression
        ...
        # @param expression [Integer] A Integer

      def expression=(expression)
        if expression!=nil and !expression.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: expression EXPECTED TYPE: Integer', nil, nil)
        end
