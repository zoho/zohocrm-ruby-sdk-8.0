  ...
  module Util
    class ModuleFieldsHandler
      ...
      def self.get_directory
        Initializer.get_initializer.resources_path + File::SEPARATOR + Constants::FIELD_DETAILS_DIRECTORY
      end

      def self.delete_fields_file
        @@sync_lock.synchronize do
          record_field_details_path = get_directory + File::SEPARATOR + Converter.new(nil).get_record_json_file_path
