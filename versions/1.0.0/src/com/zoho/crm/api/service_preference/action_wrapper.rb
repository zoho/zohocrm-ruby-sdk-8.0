  ...
  module ServicePreference
    ...
    class ActionWrapper
      ...
      def service_preferences
        ...
        # @param service_preferences [ActionResponse] An instance of ActionResponse

      def service_preferences=(service_preferences)
        if service_preferences!=nil and !service_preferences.is_a? ActionResponse
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: service_preferences EXPECTED TYPE: ActionResponse', nil, nil)
        end
