...
module ZOHOCRMSDK
  module Pipeline
    require_relative 'transfer_pipeline_action_response'
    class TransferPipelineSuccessResponse
      include Util::Model
      include TransferPipelineActionResponse

      # Creates an instance of TransferPipelineSuccessResponse
      def initialize
        @code = nil
        @message = nil
        @status = nil
