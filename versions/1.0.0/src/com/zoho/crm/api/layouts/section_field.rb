  ...
  module Layouts
    class SectionField < Fields::Fields
      ...
      def delete
        ...
        # @param delete [Delete1] An instance of Delete1

      def delete=(delete)
        if delete!=nil and !delete.is_a? Delete1
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: delete EXPECTED TYPE: Delete1', nil, nil)
        end
        @delete = delete
      ...
      def auto_number_71
        ...
        # @param auto_number_71 [Fields::AutoNumber] An instance of Fields::AutoNumber

      def auto_number_71=(auto_number_71)
        if auto_number_71!=nil and !auto_number_71.is_a? Fields::AutoNumber
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: auto_number_71 EXPECTED TYPE: AutoNumber', nil, nil)
        end
        @auto_number_71 = auto_number_71
