  ...
  module Timelines
    ...
    class ResponseWrapper
      ...
      def timeline
        ...
        # @param timeline [Array] An instance of Array

      def timeline=(timeline)
        if timeline!=nil and !timeline.is_a? Array
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: timeline EXPECTED TYPE: Array', nil, nil)
        end
        @timeline = timeline
        @key_modified['__timeline'] = 1
      end
