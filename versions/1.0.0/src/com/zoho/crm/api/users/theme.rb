  ...
  module Users
    class Theme
      ...
      def normal_tab
        ...
        # @param normal_tab [Tab] An instance of Tab

      def normal_tab=(normal_tab)
        if normal_tab!=nil and !normal_tab.is_a? Tab
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: normal_tab EXPECTED TYPE: Tab', nil, nil)
        end
      ...
      def selected_tab
        ...
        # @param selected_tab [Tab] An instance of Tab

      def selected_tab=(selected_tab)
        if selected_tab!=nil and !selected_tab.is_a? Tab
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: selected_tab EXPECTED TYPE: Tab', nil, nil)
        end
      ...
      def screen
        ...
        # @param screen [Util::Choice] An instance of Util::Choice

      def screen=(screen)
        if screen!=nil and !screen.is_a? Util::Choice
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: screen EXPECTED TYPE: Util::Choice', nil, nil)
        end
        @screen = screen
