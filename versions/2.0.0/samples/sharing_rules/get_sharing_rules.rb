...
class GetSharingRules
		def self.get_sharing_rules(module_api_name)
			...
			response = sharing_rules_operations.get_sharing_rules(param_instance)
			if response != nil
	...
	def self.initialize_and_call
			begin
				...
				get_sharing_rules(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
GetSharingRules.initialize_and_call