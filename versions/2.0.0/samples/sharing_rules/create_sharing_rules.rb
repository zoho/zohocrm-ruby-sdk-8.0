...
class CreateSharingRules
		def self.create_sharing_rules(module_api_name)
			...
			sharing_rule.name="TestJavaSDK"
			
			sharing_rules.push(sharing_rule)
			request.sharing_rules = sharing_rules
			response = sharing_rules_operations.create_sharing_rules(request)
			if response != nil
	...
	def self.initialize_and_call
			begin
				...
				create_sharing_rules(module_api_name)
			rescue Exception => e
				raise e
			end
		end
end
CreateSharingRules.initialize_and_call