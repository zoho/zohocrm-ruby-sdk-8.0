  ...
  module BulkWrite
    class FieldMapping
      ...
      def default_value
        ...
        # @param default_value [DefaultValue] An instance of DefaultValue

      def default_value=(default_value)
        if default_value!=nil and !default_value.is_a? DefaultValue
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: default_value EXPECTED TYPE: DefaultValue', nil, nil)
        end
