  ...
  module Blueprint
    class BluePrint
      ...
      def transition_id
        ...
        # @param transition_id [String] A String

      def transition_id=(transition_id)
        if transition_id!=nil and !transition_id.is_a? String
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: transition_id EXPECTED TYPE: String', nil, nil)
        end
