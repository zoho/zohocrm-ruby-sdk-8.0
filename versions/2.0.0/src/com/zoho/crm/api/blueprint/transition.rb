  ...
  module Blueprint
    class Transition
      ...
      def sequence
        ...
        # @param sequence [Integer] A Integer

      def sequence=(sequence)
        if sequence!=nil and !sequence.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: sequence EXPECTED TYPE: Integer', nil, nil)
        end
        @sequence = sequence
        @key_modified['sequence'] = 1
      end
      ...
      def next_field_value=(next_field_value)
        ...
        # The method to get the text_color_code
        # @return A String value
      ...
      def text_color_code
        ...
        # The method to set the value to text_color_code
        # @param text_color_code [String] A String

      def text_color_code=(text_color_code)
        if text_color_code!=nil and !text_color_code.is_a? String
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: text_color_code EXPECTED TYPE: String', nil, nil)
        end
        @text_color_code = text_color_code
        @key_modified['text_color_code'] = 1
      end
