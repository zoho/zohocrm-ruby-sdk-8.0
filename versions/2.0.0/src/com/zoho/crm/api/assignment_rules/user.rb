  ...
  module AssignmentRules
    class User < Users::MinifiedUser
      ...
      def zuid
        ...
        # @param zuid [Integer] A Integer

      def zuid=(zuid)
        if zuid!=nil and !zuid.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: zuid EXPECTED TYPE: Integer', nil, nil)
        end
        @zuid = zuid
        @key_modified['zuid'] = 1
      end
