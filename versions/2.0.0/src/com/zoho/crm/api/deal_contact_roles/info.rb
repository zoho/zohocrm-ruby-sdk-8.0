  ...
  module DealContactRoles
    class Info
      ...
      def page_token_expiry
        ...
        # @param page_token_expiry [String] A String

      def page_token_expiry=(page_token_expiry)
        if page_token_expiry!=nil and !page_token_expiry.is_a? String
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: page_token_expiry EXPECTED TYPE: String', nil, nil)
        end
