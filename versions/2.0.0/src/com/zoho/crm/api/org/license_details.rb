  ...
  module Org
    class LicenseDetails
      ...
      def paid_type=(paid_type)
        ...
        # The method to get the trial_action
        # @return A String value
      ...
      def trial_action
        ...
        # The method to set the value to trial_action
        # @param trial_action [String] A String

      def trial_action=(trial_action)
        if trial_action!=nil and !trial_action.is_a? String
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: trial_action EXPECTED TYPE: String', nil, nil)
        end
        @trial_action = trial_action
        @key_modified['trial_action'] = 1
      end
