  ...
  module Fields
    class Currency
      ...
      def rounding_option
        ...
        # @param rounding_option [Util::Choice] An instance of Util::Choice

      def rounding_option=(rounding_option)
        if rounding_option!=nil and !rounding_option.is_a? Util::Choice
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: rounding_option EXPECTED TYPE: Util::Choice', nil, nil)
        end
