  ...
  module Variables
    class VariablesOperations
      ...
      def get_variables(param_instance=nil)
        ...
        api_path = ''
        api_path = api_path + '/crm/v8/settings/variables'
      ...
      def get_variable_by_id(id, param_instance=nil)
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def update_variable_by_id(id, request, param_instance=nil)
        if !id.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: id EXPECTED TYPE: Integer', nil, nil)
        end
        if request!=nil and !request.is_a? BodyWrapper
      ...
      def delete_variable(id)
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def update_variable_by_apiname(api_name, request, param_instance=nil)
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def get_variable_by_apiname(api_name, param_instance=nil)
        if !api_name.is_a? String
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: api_name EXPECTED TYPE: String', nil, nil)
        end
        if param_instance!=nil and !param_instance.is_a? ParameterMap
      ...
      class UpdateVariableByIDParam
          @@group =   Param.new('group', 'com.zoho.crm.api.Variables.UpdateVariableByIDParam')
        def self.group
          @@group
        end
      end
      ...
      class UpdateVariableByAPINameParam
          @@group =   Param.new('group', 'com.zoho.crm.api.Variables.UpdateVariableByAPINameParam')
        def self.group
          @@group
        end
      end
      ...
      class GetVariableByAPINameParam
          @@group =   Param.new('group', 'com.zoho.crm.api.Variables.GetVariableByAPINameParam')
        def self.group
          @@group
        end
      end
