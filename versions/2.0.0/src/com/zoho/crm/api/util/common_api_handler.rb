  ...
  module Handler
    ...
    class CommonAPIHandler
      ...
      def api_call(class_name, encode_type)
        ...
        begin
          connector.headers[Constants::ZOHO_SDK] = RUBY_PLATFORM + "/ruby-8.0/" + RUBY_VERSION + ":" + Constants::SDK_VERSION
          ...
          unless response.body.nil?
            if headers.include? Constants::CONTENT_TYPE
              ...
              response_object = converter_instance.get_wrapped_response(response, class_name)

              unless response_object.nil?
                if !response_object[0].nil?
                  return_object = response_object[0]
                end
                if response_object.size == 2 && !response_object[1].nil?
          ...
          Response::APIResponse.new(headers, status_code, return_object, is_model, response_json)
        rescue SDKException => e
