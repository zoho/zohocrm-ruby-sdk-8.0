  ...
  module AppointmentPreference
    ...
    class ActionWrapper
      ...
      def appointment_preferences
        ...
        # @param appointment_preferences [ActionResponse] An instance of ActionResponse

      def appointment_preferences=(appointment_preferences)
        if appointment_preferences!=nil and !appointment_preferences.is_a? ActionResponse
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: appointment_preferences EXPECTED TYPE: ActionResponse', nil, nil)
        end
