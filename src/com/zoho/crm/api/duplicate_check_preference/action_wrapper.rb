  ...
  module DuplicateCheckPreference
    ...
    class ActionWrapper
      ...
      def duplicate_check_preference
        ...
        # @param duplicate_check_preference [ActionResponse] An instance of ActionResponse

      def duplicate_check_preference=(duplicate_check_preference)
        if duplicate_check_preference!=nil and !duplicate_check_preference.is_a? ActionResponse
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: duplicate_check_preference EXPECTED TYPE: ActionResponse', nil, nil)
        end
