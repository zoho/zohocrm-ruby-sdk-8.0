    ...
    class NotesOperations
      ...
      class GetNotesParam
        ...
        def self.fields
          ...
          @@sort_order =   Param.new('sort_order', 'com.zoho.crm.api.Notes.GetNotesParam')
        def self.sort_order
          @@sort_order
        end
          @@sort_by =   Param.new('sort_by', 'com.zoho.crm.api.Notes.GetNotesParam')
        def self.sort_by
          @@sort_by
        end
          @@ids =   Param.new('ids', 'com.zoho.crm.api.Notes.GetNotesParam')
        def self.ids
          @@ids
        end
      end
