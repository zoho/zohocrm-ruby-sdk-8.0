...
module ZOHOCRMSDK
  module InventoryMassConvert
    class InventoryMassConvertOperations
      ...
      # @raise SDKException
      def mass_inventory_convert(request)
        ...
        # @return An instance of APIResponse
      # @raise SDKException
      def get_scheduled_jobs_details(param_instance=nil)
      ...
      class GetScheduledJobsDetailsParam
          @@job_id =   Param.new('job_id', 'com.zoho.crm.api.InventoryMassConvert.GetScheduledJobsDetailsParam')
        def self.job_id
          @@job_id
        end
      end
