  ...
  module Tags
    ...
    class RecordActionWrapper
      ...
      def locked_count
        ...
        # @param locked_count [String] A String

      def locked_count=(locked_count)
        if locked_count!=nil and !locked_count.is_a? String
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: locked_count EXPECTED TYPE: String', nil, nil)
        end
