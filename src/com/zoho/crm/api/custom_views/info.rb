  ...
  module CustomViews
    class Info
      ...
      def default
        ...
        # @param default [Integer] A Integer

      def default=(default)
        if default!=nil and !default.is_a? Integer
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: default EXPECTED TYPE: Integer', nil, nil)
        end
        @default = default
      ...
      def translation=(translation)
        if translation!=nil and !translation.is_a? Translation
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: translation EXPECTED TYPE: Translation', nil, nil)
        end
        @translation = translation
        @key_modified['translation'] = 1
      end
