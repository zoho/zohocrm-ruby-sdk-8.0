  ...
  module Features
    ...
    class ResponseWrapper
      ...
      def features
        ...
        # @param features [Array] An instance of Array

      def features=(features)
        if features!=nil and !features.is_a? Array
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: features EXPECTED TYPE: Array', nil, nil)
        end
        @features = features
        @key_modified['__features'] = 1
      end
