  ...
  module Features
    class Feature
      ...
      def api_name=(api_name)
        ...
        # The method to get the parent_feature
      ...
      def parent_feature
        ...
        # The method to set the value to parent_feature
        # @param parent_feature [Feature] An instance of Feature

      def parent_feature=(parent_feature)
        if parent_feature!=nil and !parent_feature.is_a? Feature
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: parent_feature EXPECTED TYPE: Feature', nil, nil)
        end
        @parent_feature = parent_feature
        @key_modified['parent_feature'] = 1
      end
      ...
      def components
        ...
        # @param components [Array] An instance of Array

      def components=(components)
        if components!=nil and !components.is_a? Array
          raise SDKException.new(Constants::DATA_TYPE_ERROR, 'KEY: components EXPECTED TYPE: Array', nil, nil)
        end
        @components = components
        @key_modified['components'] = 1
      end
